...
from actions1.CustomActions import RemoveObjectTogether, DropObject, Idle, CarryObject, Drop, CarryObjectTogether, \
    DropObjectTogether
...
def add_drop_off_zones(builder, task_type):
    if task_type == "official":
        ...
        for nr_zone in range(nr_drop_zones):
            builder.add_area((23, 8), width=1, height=8, name=f"Drop off {nr_zone}", visualize_opacity=0.5,
                             visualize_colour=drop_off_color, drop_zone_nr=nr_zone, is_drop_zone=True,
                             is_goal_block=False, is_collectable=False)
    if task_type == "tutorial":
        nr_drop_zones = 1
        for nr_zone in range(nr_drop_zones):
            builder.add_area((17, 7), width=1, height=4, name=f"Drop off {nr_zone}", visualize_opacity=0.5,
                             visualize_colour=drop_off_color, drop_zone_nr=nr_zone, is_drop_zone=True,
                             is_goal_block=False, is_collectable=False)
...
def add_agents(builder, task_type, condition):
    ...
    sense_capability_agent = SenseCapability(
        {AgentBody: agent_sense_range, CollectableBlock: object_sense_range, None: other_sense_range,
         ObstacleObject: 1})
    # Define the human's sense capabilities
    sense_capability_human = SenseCapability(
        {AgentBody: agent_sense_range, CollectableBlock: object_sense_range, None: other_sense_range,
         ObstacleObject: 1})
    ...
    for team in range(nr_teams):
        ...
        for agent_nr in range(nr_agents):
            if task_type == "official":
                brain = OfficialAgent(slowdown=8,
                                      condition=condition)  # Slowdown makes the agent a bit slower, do not change value during evaluations
                brain2 = ObjectAddingAgent(slowdown=1, condition=condition)
                loc = (22, 11)
                builder.add_agent(loc, brain, team=team_name, name="RescueBot", customizable_properties=['score'],
                                  score=0, sense_capability=sense_capability_agent, is_traversable=True,
                                  img_name="/images/robot-final4.svg")
                builder.add_agent((22, 10), brain2, team=team_name, name="ObjectAdder",
                                  customizable_properties=['score'], score=0, sense_capability=sense_capability_agent,
                                  is_traversable=True, visualize_shape=1, visualize_opacity=0)
        ...
        for human_agent_nr in range(human_agents_per_team):
            brain = HumanBrain(max_carry_objects=1, grab_range=1, drop_range=0, remove_range=1,
                               fov_occlusion=fov_occlusion, condition=condition)
            if task_type == "official":
                loc = (22, 12)
            else:
                loc = (16, 9)
            builder.add_human_agent(loc, brain, team=team_name, name='human', key_action_map=key_action_map,
                                    sense_capability=sense_capability_human, is_traversable=True,
                                    img_name="/images/rescue-man-final3.svg", visualize_when_busy=True)
...
def create_builder(task_type, condition):
    ...
    if task_type == "official":
        ...
        builder = WorldBuilder(shape=[25, 24], tick_duration=tick_duration, run_matrx_api=True,
                               run_matrx_visualizer=False, verbose=verbose, simulation_goal=goal,
                               visualization_bg_clr='#9a9083')
    else:
        # Create the collection goal
    ...
    if task_type == "tutorial":
        builder.add_room(top_left_location=(0, 0), width=19, height=19, name="world_bounds",
                         wall_visualize_colour="#343a40")
        builder.add_room(top_left_location=(1, 1), width=5, height=4, name='area 1', door_locations=[(3, 4)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (3, 5)})
        builder.add_room(top_left_location=(7, 1), width=5, height=4, name='area 2', door_locations=[(9, 4)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (9, 5)})
        builder.add_room(top_left_location=(13, 1), width=5, height=4, name='area 3', door_locations=[(15, 4)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (15, 5)})
        builder.add_room(top_left_location=(1, 7), width=5, height=4, name='area 4', door_locations=[(3, 7)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (3, 6)})
        builder.add_room(top_left_location=(7, 7), width=5, height=4, name='area 5', door_locations=[(9, 7)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (9, 6)})
        builder.add_room(top_left_location=(1, 13), width=5, height=4, name='area 6', door_locations=[(3, 16)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (3, 17)})
        builder.add_room(top_left_location=(7, 13), width=5, height=4, name='area 7', door_locations=[(9, 16)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (9, 17)})
        builder.add_room(top_left_location=(13, 13), width=5, height=4, name='area 8', door_locations=[(15, 16)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (15, 17)})
        ...
        builder.add_object((15, 16), 'stones', ObstacleObject, visualize_shape='img',
                           img_name="/images/stone-small.svg")
        ...
        builder.add_object((14, 14), 'healthy man in area 8', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy man.svg")
        ...
        builder.add_object((2, 14), 'healthy girl in area 6', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy girl.svg")
        ...
        builder.add_object((10, 3), 'healthy boy in area 2', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy boy.svg")
        ...
        builder.add_object((10, 15), 'healthy dog in area 7', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy dog.svg")

        builder.add_object((17, 7), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/critically injured girl.svg", drop_zone_nr=0)
        builder.add_object((17, 8), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/critically injured elderly woman.svg", drop_zone_nr=0)
        builder.add_object((17, 9), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/mildly injured boy.svg", drop_zone_nr=0)
        builder.add_object((17, 10), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/mildly injured elderly man.svg", drop_zone_nr=0)

        builder.add_object(location=[3, 1], is_traversable=True, is_movable=False, name="area 01 sign",
                           img_name="/images/sign01.svg", visualize_depth=110, visualize_size=0.5)
        builder.add_object(location=[9, 1], is_traversable=True, is_movable=False, name="area 02 sign",
                           img_name="/images/sign02.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[15, 1], is_traversable=True, is_movable=False, name="area 03 sign",
                           img_name="/images/sign03.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[3, 10], is_traversable=True, is_movable=False, name="area 04 sign",
                           img_name="/images/sign04.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[9, 10], is_traversable=True, is_movable=False, name="area 05 sign",
                           img_name="/images/sign05.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[3, 13], is_traversable=True, is_movable=False, name="area 06 sign",
                           img_name="/images/sign06.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[9, 13], is_traversable=True, is_movable=False, name="area 07 sign",
                           img_name="/images/sign07.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[15, 13], is_traversable=True, is_movable=False, name="area 08 sign",
                           img_name="/images/sign08.svg", visualize_depth=110, visualize_size=0.55)

        builder.add_object(location=[9, 0], is_traversable=True, name="keyboard sign",
                           img_name="/images/keyboard-final.svg", visualize_depth=110, visualize_size=15)

        for loc in [(1, 1), (2, 1), (3, 1), (4, 1), (5, 1), (1, 2), (1, 3), (1, 4), (2, 4), (4, 4), (5, 4), (5, 3),
                    (5, 2), (7, 1), (8, 1),
                    (13, 1), (14, 1), (15, 1), (16, 1), (17, 1), (13, 1), (14, 1), (15, 1), (16, 1), (17, 1), (13, 2),
                    (13, 3), (13, 4),
                    (1, 7), (1, 8), (1, 9), (1, 10), (2, 10), (3, 10), (4, 10), (5, 10), (5, 9), (5, 8), (5, 7), (4, 7),
                    (2, 7), (8, 4),
                    (7, 7), (7, 8), (7, 9), (7, 10), (8, 10), (9, 10), (10, 10), (11, 10), (11, 9), (11, 8), (11, 7),
                    (10, 7), (8, 7),
                    (1, 13), (2, 13), (3, 13), (4, 13), (5, 13), (1, 14), (1, 15), (1, 16), (2, 16), (4, 16), (5, 16),
                    (5, 15), (5, 14),
                    (7, 13), (8, 13), (9, 13), (10, 13), (11, 13), (7, 14), (7, 15), (7, 16), (8, 16), (10, 16),
                    (11, 16), (11, 15),
                    (11, 14), (17, 16), (16, 16), (5, 13), (14, 4), (16, 4), (17, 4), (17, 3), (17, 2), (9, 1), (10, 1),
                    (11, 1), (7, 2),
                    (13, 13), (14, 13), (15, 13), (16, 13), (17, 13), (13, 14), (13, 15), (13, 16), (14, 16), (17, 14),
                    (17, 15),
                    (7, 3), (7, 4), (11, 2), (11, 3), (11, 4), (10, 4)]:
            builder.add_object(loc, 'roof', EnvObject, is_traversable=True, is_movable=False, visualize_shape='img',
    ...
    if task_type == "official":
        ...
        builder.add_room(top_left_location=(13, 1), width=5, height=4, name='area 3', door_locations=[(15, 4)],
                         ...
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (15, 5)})
        builder.add_room(top_left_location=(19, 1), width=5, height=4, name='area 4', door_locations=[(21, 4)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (21, 5)})
        builder.add_room(top_left_location=(1, 7), width=5, height=4, name='area 5', door_locations=[(3, 7)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (3, 6)})
        builder.add_room(top_left_location=(7, 7), width=5, height=4, name='area 6', door_locations=[(9, 7)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (9, 6)})
        builder.add_room(top_left_location=(13, 7), width=5, height=4, name='area 7', door_locations=[(15, 7)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (15, 6)})
        builder.add_room(top_left_location=(1, 13), width=5, height=4, name='area 8', door_locations=[(3, 16)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (3, 17)})
        builder.add_room(top_left_location=(7, 13), width=5, height=4, name='area 9', door_locations=[(9, 16)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (9, 17)})
        builder.add_room(top_left_location=(13, 13), width=5, height=4, name='area 10', door_locations=[(15, 16)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (15, 17)})
        builder.add_room(top_left_location=(1, 19), width=5, height=4, name='area 11', door_locations=[(3, 19)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (3, 18)})
        builder.add_room(top_left_location=(7, 19), width=5, height=4, name='area 12', door_locations=[(9, 19)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (9, 18)})
        builder.add_room(top_left_location=(13, 19), width=5, height=4, name='area 13', door_locations=[(15, 19)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (15, 18)})
        builder.add_room(top_left_location=(19, 19), width=5, height=4, name='area 14', door_locations=[(21, 19)],
                         doors_open=True, wall_visualize_colour=wall_color, with_area_tiles=True,
                         area_visualize_colour='#0008ff', area_visualize_opacity=0.0, door_open_colour='#9a9083',
                         area_custom_properties={'doormat': (21, 18)})
        ...
        builder.add_object((21, 19), 'stones', ObstacleObject, visualize_shape='img',
                           img_name="/images/stone-small.svg")
        ...
        builder.add_object((1, 12), 'plant', EnvObject, is_traversable=True, is_movable=False, visualize_shape='img',
                           img_name="/images/tree.svg", visualize_size=3)

        builder.add_object((23, 8), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/critically injured girl.svg", drop_zone_nr=0)
        builder.add_object((23, 9), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/critically injured elderly woman.svg", drop_zone_nr=0)
        builder.add_object((23, 10), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/critically injured man.svg", drop_zone_nr=0)
        builder.add_object((23, 11), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/critically injured dog.svg", drop_zone_nr=0)
        builder.add_object((23, 12), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/mildly injured boy.svg", drop_zone_nr=0)
        builder.add_object((23, 13), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/mildly injured elderly man.svg", drop_zone_nr=0)
        builder.add_object((23, 14), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/mildly injured woman.svg", drop_zone_nr=0)
        builder.add_object((23, 15), name="Collect Block", callable_class=GhostBlock, visualize_shape='img',
                           img_name="/images/mildly injured cat.svg", drop_zone_nr=0)
        ...
        builder.add_object((14, 14), 'healthy man in area 10', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy man.svg")
        ...
        builder.add_object((2, 14), 'healthy girl in area 8', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy girl.svg")
        ...
        builder.add_object((2, 2), 'mildly injured boy in area 1', callable_class=CollectableBlock,
                           visualize_shape='img', img_name="/images/mildly injured boy.svg")
        builder.add_object((16, 3), 'healthy boy in area 3', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy boy.svg")
        ...
        builder.add_object((16, 21), 'healthy woman in area 13', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy woman.svg")
        ...
        builder.add_object((10, 21), 'healthy girl in area 12', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy girl.svg")
        builder.add_object((16, 9), 'healthy girl in area 7', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy girl.svg")
        builder.add_object((22, 3), 'healthy boy in area 4', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy boy.svg")
        builder.add_object((2, 20), 'healthy elderly woman in area 11', callable_class=CollectableBlock,
                           visualize_shape='img', img_name="/images/healthy elderly woman.svg")
        builder.add_object((20, 2), 'healthy man in area 4', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy man.svg")
        builder.add_object((20, 20), 'healthy man in area 14', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy man.svg")
        builder.add_object((22, 21), 'healthy boy in area 14', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy boy.svg")
        builder.add_object((8, 14), 'healthy boy in area 9', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy boy.svg")
        ...
        builder.add_object((14, 2), 'healthy elderly man in area 3', callable_class=CollectableBlock,
                           visualize_shape='img', img_name="/images/healthy elderly man.svg")
        builder.add_object((16, 15), 'healthy woman in area 10', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy woman.svg")
        builder.add_object((8, 2), 'healthy woman in area 2', callable_class=CollectableBlock, visualize_shape='img',
                           img_name="/images/healthy woman.svg")
        ...
        builder.add_object(location=[15, 1], is_traversable=True, is_movable=False, name="area 03 sign",
                           img_name="/images/sign03.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[21, 1], is_traversable=True, is_movable=False, name="area 04 sign",
                           img_name="/images/sign04.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[3, 10], is_traversable=True, is_movable=False, name="area 05 sign",
                           img_name="/images/sign05.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[9, 10], is_traversable=True, is_movable=False, name="area 06 sign",
                           img_name="/images/sign06.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[15, 10], is_traversable=True, is_movable=False, name="area 07 sign",
                           img_name="/images/sign07.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[3, 13], is_traversable=True, is_movable=False, name="area 08 sign",
                           img_name="/images/sign08.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[9, 13], is_traversable=True, is_movable=False, name="area 09 sign",
                           img_name="/images/sign09.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[15, 13], is_traversable=True, is_movable=False, name="area 10 sign",
                           img_name="/images/sign10.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[3, 22], is_traversable=True, is_movable=False, name="area 11 sign",
                           img_name="/images/sign11.svg", visualize_depth=110, visualize_size=0.45)
        builder.add_object(location=[9, 22], is_traversable=True, is_movable=False, name="area 12 sign",
                           img_name="/images/sign12.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[15, 22], is_traversable=True, is_movable=False, name="area 13 sign",
                           img_name="/images/sign13.svg", visualize_depth=110, visualize_size=0.55)
        builder.add_object(location=[21, 22], is_traversable=True, is_movable=False, name="area 14 sign",
                           img_name="/images/sign14.svg", visualize_depth=110, visualize_size=0.55)

        builder.add_object(location=[12, 0], is_traversable=True, name="keyboard sign",
                           img_name="/images/keyboard-final.svg", visualize_depth=110, visualize_size=20)

        for loc in [(1, 1), (2, 1), (3, 1), (4, 1), (5, 1), (1, 2), (1, 3), (1, 4), (2, 4), (4, 4), (5, 4), (5, 3),
                    (5, 2), (7, 1), (8, 1), (9, 1),
                    (10, 1), (11, 1), (7, 2), (7, 3), (7, 4), (8, 4), (11, 2), (11, 3), (11, 4), (10, 4), (16, 4),
                    (17, 4), (17, 3), (17, 2),
                    (13, 1), (14, 1), (15, 1), (16, 1), (17, 1), (13, 1), (14, 1), (15, 1), (16, 1), (17, 1), (13, 2),
                    (13, 3), (13, 4), (14, 4),
                    (19, 1), (20, 1), (21, 1), (22, 1), (23, 1), (19, 2), (19, 3), (19, 4), (20, 4), (22, 4), (23, 4),
                    (23, 3), (23, 2), (23, 1),
                    (1, 7), (1, 8), (1, 9), (1, 10), (2, 10), (3, 10), (4, 10), (5, 10), (5, 9), (5, 8), (5, 7), (4, 7),
                    (2, 7), (16, 16), (10, 19),
                    (13, 7), (13, 8), (13, 9), (13, 10), (14, 10), (15, 10), (16, 10), (17, 10), (17, 9), (17, 8),
                    (17, 7), (16, 7), (14, 7),
                    (1, 13), (2, 13), (3, 13), (4, 13), (5, 13), (1, 14), (1, 15), (1, 16), (2, 16), (4, 16), (5, 16),
                    (5, 15), (5, 14), (5, 13),
                    (7, 13), (8, 13), (9, 13), (10, 13), (11, 13), (7, 14), (7, 15), (7, 16), (8, 16), (10, 16),
                    ...
                    (13, 13), (14, 13), (15, 13), (16, 13), (17, 13), (13, 14), (13, 15), (13, 16), (14, 16), (17, 14),
                    (17, 15), (17, 16),
                    (1, 19), (2, 19), (4, 19), (5, 19), (1, 20), (1, 21), (1, 22), (2, 22), (3, 22), (4, 22), (5, 22),
                    (5, 21), (5, 20), (5, 19),
                    (7, 19), (8, 19), (4, 19), (5, 19), (7, 20), (7, 21), (7, 22), (8, 22), (9, 22), (10, 22), (11, 22),
                    (11, 21), (11, 20), (11, 19),
                    (13, 19), (14, 19), (16, 19), (17, 19), (13, 20), (13, 21), (13, 22), (14, 22), (15, 22), (16, 22),
                    (17, 22), (17, 21), (17, 20),
                    (19, 19), (20, 19), (22, 19), (23, 19), (19, 20), (19, 21), (19, 22), (20, 22), (21, 22), (22, 22),
                    (23, 22), (23, 21), (23, 20),
                    (7, 7), (7, 8), (7, 9), (7, 10), (8, 10), (9, 10), (10, 10), (11, 10), (11, 9), (11, 8), (11, 7),
                    (10, 7), (8, 7)]:
            builder.add_object(loc, 'roof', EnvObject, is_traversable=True, is_movable=False, visualize_shape='img',
        ...
        for loc in [(6, 1), (6, 2), (6, 3), (6, 4), (6, 5), (6, 12), (6, 13), (6, 14), (6, 15), (6, 16), (6, 17),
                    (11, 12), (11, 11), (18, 12), (18, 21),
                    (3, 12), (3, 11), (12, 6), (12, 7), (12, 8), (12, 9), (12, 10), (12, 11), (18, 11), (18, 10),
                    (18, 9), (19, 9), (19, 8), (18, 22),
                    (18, 13), (18, 14), (18, 15), (18, 16), (18, 17), (9, 17), (9, 18), (20, 17), (20, 18), (12, 1),
                    (12, 2), (6, 22), (18, 20),
                    (19, 7), (19, 6), (19, 5), (10, 6), (10, 5), (14, 17), (14, 18), (12, 19), (12, 20), (12, 21),
                    (12, 18), (12, 22)]:
            builder.add_object(loc, 'water', EnvObject, is_traversable=True, is_movable=False, visualize_shape='img',
                               img_name="/images/pool20.svg")

        for loc in [(1, 11), (2, 11), (3, 11), (3, 12), (4, 12), (5, 12), (6, 12), (7, 12), (8, 12), (9, 12), (10, 12),
                    (11, 12), (12, 11), (13, 11), (20, 17),
                    (14, 11), (15, 11), (16, 11), (17, 11), (18, 11), (6, 17), (7, 17), (8, 17), (9, 17), (9, 18),
                    (5, 17), (4, 17), (3, 17), (2, 17), (1, 17),
                    (18, 9), (19, 9), (19, 5), (20, 5), (21, 5), (22, 5), (23, 5), (11, 6), (12, 6), (10, 6), (10, 5),
                    (9, 5), (8, 5), (7, 5), (6, 5), (19, 17),
                    (11, 11), (18, 17), (17, 17), (16, 17), (15, 17), (14, 17), (14, 18), (13, 18), (12, 18), (10, 18),
                    (11, 18)]:
            builder.add_object(loc, 'water', EnvObject, is_traversable=True, is_movable=False, visualize_shape='img',
                               img_name="/images/lake2.svg")

        for loc in [(12, 3), (12, 4), (18, 1), (18, 2), (18, 3), (18, 4), (6, 19), (6, 20), (6, 21), (18, 19)]:
            builder.add_object(loc, 'plant', EnvObject, is_traversable=True, is_movable=False, visualize_shape='img',
                               img_name="/images/tree.svg", visualize_size=1.25)
